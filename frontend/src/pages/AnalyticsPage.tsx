...
export default function AnalyticsPage() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-ink-600">Last 30 days</p>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
          ...
          {data.by_day.length === 0 ? (
            ...
            <div className="mt-5 flex h-44 items-end gap-1">
              {data.by_day.map((day) => (
                ...
                >
                  <div
                    className="w-full rounded-t bg-ink-900/85 transition group-hover:bg-ink-900"
                    style={{
        ...
        <div className="card p-5">
          ...
          {purposes.length === 0 ? (
            <p className="mt-6 text-center text-sm text-ink-500">No data yet.</p>
          ) : (
